...
void readimu() {
  ...
  String GZ = String(GyZ / imu_6050_g);
...
void battery_check() {
  ...
  if (millis() > publisher_timer_battery) {
    battery_msg.data = sensor_battery_Value;
